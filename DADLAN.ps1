...
$menu['network'] = @('Test-Wireguard','Start-WireGuard','Install-Wireguard')
$menuaction['network'] = @("Test-Wireguard -info $true","Start-Wireguard","Installexe -url $global:download['wireguard']")
