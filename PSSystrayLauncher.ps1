...
$SystrayIcon = [System.Drawing.Icon]::ExtractAssociatedIcon("C:\DADLAN\DADLAN-LOGO.ico")
...
$LoggedOnUser = New-MenuItem -Text "Get Logged On User" -MyScriptPath "C:\DADLAN\Scripts\GetLoggedOn.ps1"
$RestartRemoteComputer = New-MenuItem -Text "Restart Remote PC" -MyScriptPath "C:\DADLAN\Scripts\restartpc.ps1"
